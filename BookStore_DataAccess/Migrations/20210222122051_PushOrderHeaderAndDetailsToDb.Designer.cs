...
namespace BookStore_DataAccess.Migrations
{
    ...
    [Migration("20210222122051_PushOrderHeaderAndDetailsToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStore_Models.InquiryDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookStore_Models.InquiryHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookStore_Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookStore_Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookStore_Models.InquiryDetail", b =>
                {
                    b.HasOne("BookStore_Models.InquiryHeader", "InquiryHeader")
                        .WithMany()
                        .HasForeignKey("InquiryHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookStore_Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("BookStore_Models.InquiryHeader", b =>
                {
                    b.HasOne("BookStore_Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BookStore_Models.OrderDetail", b =>
                {
                    b.HasOne("BookStore_Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("BookStore_Models.OrderHeader", b =>
                {
                    b.HasOne("BookStore_Models.ApplicationUser", "CreatedBy")
                        .WithMany()
